...
//				$.ajax({
					type: "DELETE",
					url: dominio+"projects/"+project_id+"/canvas_projects/"+canvas_id+"/canvas_tickets/"+id+".json?key=952345c19473c95e65c45e8307e51bfab617e51b",
					contentType: "application/json",
					dataType: "json"
				});
				alert("Mock OK\n"+dominio+"projects/"+project_id+"/canvas_projects/"+canvas_id+"/canvas_tickets/"+id+".json");			
...
//							$.ajax({
							...
							alert("Mock OK");				
//							alert(dominio+"projects/"+project_id+"/canvas_projects/"+canvas_id+"/canvas_tickets/"+id+".json");
	//						alert("Antes:"+content+"\nDepois:"+depois);
						}		
					}
...
//					$.ajax({
						type: "POST",
						url: dominio+"projects/"+project_id+"/canvas_projects/"+canvas_id+"/canvas_tickets.json?key=952345c19473c95e65c45e8307e51bfab617e51b",
						contentType: "application/json",
						dataType: "json",
						data: {"data_inicio":null,"canvas_box_id":canvas_box_id,"efeito":null,"canvas_project_id":canvas_id,"data_fim":null,"causa":null,"text":depois}
					});
					alert( "Mock OK\n"+
							dominio+"projects/"+project_id+"/canvas_projects/"+canvas_id+"/canvas_tickets.json\n"+
							canvas_box_id+"\n"+
							depois
					);
				}
