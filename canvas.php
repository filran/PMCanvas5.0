...
<ul id="postits" class="postits" drop="auto">
    <ul class="receberpostit"> 
        <li postit-id="99999" class="postit" autor="Filipe Arantes" areacandidata="just">TEXTO</li>
    </ul>        
</ul>
    ...
    <ul id="pmcanvas">
        ...
        <ul id="area" class="area">
            <li id="just" canvas_box_id="1" class="margem_direita margem_embaixo">
                ...
                <ul class="receberpostit">
					<li postit-id="99" class="postit">Postitit aqui</li>
				</ul>
            </li>
...
<!--LER JSON-->
<script type="text/javascript" src="json/get_postits2.js"></script>
